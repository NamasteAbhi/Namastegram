...
def GetFollowingTimelineFeed(
    ...
    return requests.get("https://namastegram.p.rapidapi.com/getFollowingTimelinefeed", headers=headers, params=querystring).text
...
if __name__ == '__main__':
    ...
    print(GetFollowingTimelineFeed(LoginData,Proxy))
