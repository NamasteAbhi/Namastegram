...
def GetHashTagInfo(
    ...
    return requests.get("https://namastegram.p.rapidapi.com/hashtaginfo", headers=headers, params=querystring).text
...
if __name__ == '__main__':
    ...
    HashTag= 'picoftheday' #Enter Hashtag Here
    print(GetHashTagInfo(LoginData,HashTag,Proxy))
