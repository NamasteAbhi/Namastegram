...
def UsernameToUserid(
    ...
    return requests.get("https://namastegram.p.rapidapi.com/usernametouserid", headers=headers, params=querystring).text
...
if __name__ == '__main__':
    ...
    Username='instagram' #Enter Username To Get Userid
    print(UsernameToUserid(LoginData,Username,Proxy))
