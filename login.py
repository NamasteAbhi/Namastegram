...
def Login(UserName:str,
	...
	return requests.get('https://namastegram.p.rapidapi.com/login', headers=headers, params=querystring).text
if __name__ == '__main__':

	Username=''	#Enter UserName Here
	Password=''	#Enter Password Here
	Proxy=''	#Enter Proxy Here In This Format ( username:password@host:port )
	print(Login(Username,Password,Proxy))

# If Login Success They Return This Response
