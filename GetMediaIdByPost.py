...
def GetMediaId(
    ...
    return requests.get("https://namastegram.p.rapidapi.com/shorttomediaid", headers=headers, params=querystring).text
...
if __name__ == '__main__':
    ...
    ShortCode= 'C44Irk8vg9b' #https://www.instagram.com/p/C44Irk8vg9b/
    print(GetMediaId(LoginData,ShortCode,Proxy))

    #Success Response

    '''{
  "Media_Id": "3330450103423864667"
}
'''
