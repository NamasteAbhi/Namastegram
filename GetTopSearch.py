...
def GetTopSearch(
    ...
    return requests.get("https://namastegram.p.rapidapi.com/topsearch", headers=headers, params=querystring).text
...
if __name__ == '__main__':
    ...
    Query= 'instagram' #Enter Query Here
    print(GetTopSearch(LoginData,Query,Proxy))
